...
export class CountdownService {
  // TODO: would it be better to use the caller's destroy ref instead of the service's? The service will last awhile!
  // TODO: or we could cache the date in here and if someone else asks for that date we give them the same signal?
  private readonly destroyRef = inject(DestroyRef);

  getCountdownTime(targetDate: Date): Signal<CountdownTimeRemaining> {
